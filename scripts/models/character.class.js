...
import {
  CHARACTER_WALK, CHARACTER_IDLE, CHARACTER_SLEEP,
  CHARACTER_JUMP, CHARACTER_HURT, CHARACTER_DEAD,
} from "./constants.js";
...
export class Character extends MoveableObject {
  ...
  handleInput() {
    ...
    if (kb.RIGHT && this.x < this.canvas.level.level_end_right_x) this.walkRight();
